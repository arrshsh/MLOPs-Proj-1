...
class DataIngestion:
    def __init__(self, data_ingestion_config: DataIngestionConfig = DataIngestionConfig()):
        # params: config for data ingesiton 
        try:
    ...
    try:
        def export_data_into_feature_store(self) -> DataFrame:
            ...
            logging.info(f"Storing the exported data into feature store file path: {feature_store_file_path}")
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
            ...
            try:
                 ...
                 os.makedirs(dir_path, exist_ok= True)
                 logging.info(f"Exporting train and test file pathj ")
                 train_set.to_csv(self.data_ingestion_config.training_file_path, index = False, header = True)
                 test_set.to_csv(self.data_ingestion_config.testing_file_path, index = False, header = True)

                 logging.info(f"Exported training and testing files")
            except Exception as e:
                 raise Exception(e, sys)
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifact:
        ...
        try:
             ...
             logging.info("Performed the splitting")
             logging.info(
